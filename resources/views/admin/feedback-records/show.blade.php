                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mt-8 pt-6 border-t border-[#FFC8FB]/50 gap-4">
                        <div class="flex flex-wrap gap-3">
                            @if(!$feedbackRecord->is_read)
                                <form action="{{ route('admin.feedback-records.toggle-read', $feedbackRecord) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="{{ route('admin.feedback-records.edit', $feedbackRecord) }}" 
                               class="px-4 py-2 bg-[#FF92C2] text-white rounded-lg hover:bg-[#ff6fb5] transition-colors duration-200 font-medium flex items-center gap-2">
