                ...
                <form action="{{ route('admin.subjects.store') }}" method="POST" class="space-y-4 sm:space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div>
                            ...
                            <input type="text" name="subject_code" class="w-full rounded-lg shadow-sm bg-white border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 text-gray-800 px-4 py-2 transition-all duration-200" required>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-[#FF92C2] mb-1">Subject Name</label>
                            <input type="text" name="subject_name" class="w-full rounded-lg shadow-sm bg-white border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 text-gray-800 px-4 py-2 transition-all duration-200" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" class="w-full rounded-lg shadow-sm bg-white border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 text-gray-800 px-4 py-2 transition-all duration-200" required></textarea>
                    </div>
                        ...
                        <div class="max-h-48 overflow-y-auto p-4 border border-[#FFC8FB] rounded-lg">
                            ...
                            @foreach($instructors as $instructor)
                                <label class="flex items-center space-x-2 py-1 instructor-item">
                                    <input type="checkbox" name="instructor_ids[]" value="{{ $instructor->id }}" class="instructor-checkbox rounded border-[#FFC8FB] text-[#FF92C2] focus:ring-[#FF92C2]">
                    ...
                    <div>
                        ...
                        <input type="number" name="units" min="1" max="6" class="w-full rounded-lg shadow-sm bg-white border border-[#FFC8FB] focus:border-pink-400 focus:ring focus:ring-pink-200 text-gray-800 px-4 py-2 transition-all duration-200" required>
                    </div>
