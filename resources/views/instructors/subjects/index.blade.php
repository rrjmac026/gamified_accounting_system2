                ...
                <div class="bg-gradient-to-r from-white/90 to-[#FFF0FA]/90 backdrop-blur-sm rounded-2xl shadow-xl border border-[#FFC8FB]/30 p-6 relative overflow-hidden">
                    ...
                    <div class="relative">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-800">Find Your Subjects</h3>
                                <p class="text-sm text-gray-600">Search by subject code or name</p>
                            </div>
                        </div>

                        <form action="{{ route('instructors.subjects.index') }}" method="GET" class="space-y-4">
                            <div class="relative group">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Type subject code (e.g., CS101) or subject name..." 
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center">
                                            <span class="text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-200">
                                                ...
                                                {{ $subjects->total() ?? 0 }} subjects found
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="bg-[#FFF0FA] overflow-hidden shadow-2xl sm:rounded-2xl border border-[#FFC8FB]/30">
                <div class="p-6 text-gray-700">
                    <div class="flex items-center justify-between mb-8">
                        <h2 class="text-3xl font-bold text-[#FF92C2]">My Subjects</h2>
                        @if($subjects->count() > 0 && !request('search'))
                        ...
                        @forelse($subjects as $subject)
                            <div class="group bg-white rounded-xl shadow-md border border-[#FFC8FB]/30 overflow-hidden hover:shadow-xl hover:border-[#FF92C2]/50 transition-all duration-300 transform hover:-translate-y-1">
                                <div class="p-6">
                                    ...
                                    <p class="text-gray-600 mb-4 leading-relaxed">{{ $subject->subject_name }}</p>
                                    ...
                                    <div class="space-y-3 mb-6">
                                        <div class="flex items-center text-gray-600 bg-gray-50 rounded-lg px-3 py-2">
                                            ...
                                            <span class="font-medium">{{ $subject->students->count() }} Students</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        @if(request('search'))
                                            ...
                                            <p class="text-gray-600 mb-4 max-w-md mx-auto">
                                                We couldn't find any subjects matching <strong>"{{ request('search') }}"</strong>. 
                                                Try adjusting your search term or browse all subjects.
                                            </p>
