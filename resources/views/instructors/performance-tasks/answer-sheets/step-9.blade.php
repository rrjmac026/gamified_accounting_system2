<x-app-layout>
    ...
    <div class="py-4 sm:py-6 lg:py-8">
        ...
        <div class="answer-key-header">
            ...
            <h1 class="header-title">Answer Key: Closing Entries</h1>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form id="answerKeyForm"
                  action="{{ route('instructors.performance-tasks.answer-sheets.update', ['task' => $task, 'step' => 9]) }}"
                  method="POST">
                @csrf
                @method('PUT')
    ...
    (function () {
        ...
        // ── Fixed header rows (always forced, matching HOT defaultRow3) ───────
    ...
    {{-- ═══════════════════════════ Import modal ════════════════════════════════ --}}
    @include('instructors.performance-tasks.answer-sheets._import-modal', ['step' => 9])
    ...
    (function () {
        ...
        const HEADER_KEYWORDS = [
            ...
            'closing', 'entries', 'income', 'summary', 'revenue', 'expense',
            'capital', 'withdrawals', 'durano', 'enterprise',
        ];
