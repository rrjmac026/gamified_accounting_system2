    ...
    <div class="py-4 sm:py-6 lg:py-8">
        ...
        <div class="answer-key-header">
            <div class="step-badge">
                ...
                <span>Answer Key - Step 9 of 10</span>
            </div>
            
            <h1 class="header-title">
                Answer Key: Closing Entries
            </h1>
            
            <p class="header-description">
                Create the correct answer key for Closing Entries. This will be used to automatically grade student submissions.
            </p>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form id="answerKeyForm" action="{{ route('instructors.performance-tasks.answer-sheets.update', ['task' => $task, 'step' => 9]) }}" method="POST">
                @csrf
                @method('PUT')
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // ✅ Fixed header rows
        const defaultRow3 = ['Account Title', 'Debit (₱)', 'Credit (₱)'];
        ...
        if (!initialData) {
            ...
            // ✅ Always force correct label into row 3
            initialData[3] = defaultRow3;
        }
        ...
        hot = new Handsontable(container, {
            ...
            // ✅ All merges for rows 0, 1, 2 spanning all 3 cols
            mergeCells: [
            ...
            cells: function(row, col) {
                ...
                // ✅ Row 0 — company name, full row editable + styled
                if (row === 0) {
                ...
                // ✅ Row 1 — document title, full row editable + styled
                if (row === 1) {
                    cellProperties.readOnly = false;
                    cellProperties.renderer = function(instance, td, row, col, prop, value, cellProperties) {
                        Handsontable.renderers.TextRenderer.apply(this, arguments);
                ...
                // ✅ Row 2 — date field, full row editable + styled
                if (row === 2) {
                    cellProperties.readOnly = false;
                    cellProperties.renderer = function(instance, td, row, col, prop, value, cellProperties) {
                        Handsontable.renderers.TextRenderer.apply(this, arguments);
                ...
                // ✅ Row 3 — column headers, now editable but styled
                if (row === 3) {
                    cellProperties.readOnly = false;
                    cellProperties.renderer = function(instance, td, row, col, prop, value, cellProperties) {
                        Handsontable.renderers.TextRenderer.apply(this, arguments);
        ...
        style.textContent = `
            .formula-cell { background-color: #f8f9fa !important; }
