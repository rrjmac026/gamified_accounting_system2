                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                @if($submission)
                                                    ...
                                                    <!-- View Answers Button (Always visible for submitted steps) -->
                                                    <a href="{{ route('instructors.performance-tasks.submissions.answer-sheet', [
                                                        'task' => $task->id,
                                                        'student' => $student->id,
                                                        'step' => $stepNumber
                                                    ]) }}" 
                                                    ...
                                                    title="View correct answers for this step">
                                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
