<x-app-layout>
    ...
    <style>
        ...
        /* Rows 1-3: company / title / date — white bg, bold, centred (copied from answer sheet) */
        ...
        /* Row 4: section headers (copied from answer sheet) */
        ...
        /* Row 5: Debit / Credit sub-headers (copied from answer sheet) */
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                <form id="saveForm"
                      method="POST"
                      action="{{ route('students.performance-tasks.save-step', ['id' => $performanceTask->id, 'step' => 6]) }}">
                    @csrf
    ...
    {{-- Structure copied exactly from instructor answer sheet step 6        --}}
    <script>
    (function () {
        ...
        // ── Fixed header rows (identical to answer sheet) ─────────────────────
        ...
        if (savedDataRaw) {
            ...
            dataRows = rawData.length <= MIN_DATA_ROWS
                ...
                : rawData.slice(HEADER_ROWS);    // new format — strip 5 header rows
        ...
        function applyAnswerStyles() {
            ...
            try {
                ...
                // Start from row index 5 — skip all 5 header rows
                // Mirrors HOT: `if (row >= 5 && submissionStatus && correctData)`
