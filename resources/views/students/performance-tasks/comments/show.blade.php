...
<div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-400 mb-6">
        <a href="{{ route('students.performance-tasks.index') }}" class="hover:text-[#FF92C2] transition">Tasks</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm mb-6 overflow-hidden">
        ...
        <div class="p-5 flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 mt-0.5 text-xs text-gray-400">
                        <span><i class="fas fa-user-tie mr-1"></i>{{ $task->instructor->name ?? 'Instructor' }}</span>
            ...
            <a href="{{ route('students.performance-tasks.progress', $task->id) }}"
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <div class="flex items-center gap-2 mb-5">
            ...
            <h2 class="font-semibold text-gray-800">Discussion</h2>
            <span class="ml-auto text-xs text-gray-400">Ask your instructor questions about this task</span>
        </div>

        @include('components.task-comment-thread', [
            'comments'   => $comments,
            'task'       => $task,
            'storeRoute' => 'students.performance-tasks.comments.store',
            'role'       => 'student',
            'step'       => $step,
